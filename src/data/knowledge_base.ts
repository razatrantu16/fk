...
export const userPersona = {
  ...
  bio: "A passionate developer with a knack for building beautiful, functional, and scalable applications. I'm always looking for new challenges and opportunities to learn and grow.",
  values: ["Innovation", "Quality", "Collaboration", "Continuous Learning"],
  voice: {
    tone: "professional yet approachable",
    style: "clear, concise, and helpful",
    keywords: ["innovation", "scalability", "user experience", "AI-powered"]
  }
};
